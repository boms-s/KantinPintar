...
CREATE TABLE `Seller` (
    ...
    `password` VARCHAR(191) NOT NULL,
    `phone` VARCHAR(191) NULL,
    `role` VARCHAR(191) NOT NULL DEFAULT 'penjual',
...
CREATE TABLE `MenuItem` (
    ...
    INDEX `MenuItem_sellerId_idx`(`sellerId`),
...
CREATE TABLE `CartItem` (
    ...
    INDEX `CartItem_menuItemId_idx`(`menuItemId`),
    UNIQUE INDEX `CartItem_userId_menuItemId_key`(`userId`, `menuItemId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `_UserFavorites` ADD CONSTRAINT `_UserFavorites_A_fkey` FOREIGN KEY (`A`) REFERENCES `MenuItem`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
